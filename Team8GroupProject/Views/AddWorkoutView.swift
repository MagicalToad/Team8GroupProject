...
struct AddWorkoutView: View {
    ...
    private func saveWorkout() {
        var weightInKg: Double? = nil
         if selectedWorkoutTypeRawValue == "Weightlifting" && weightLbs > 0 {
             weightInKg = weightLbs * kgPerLb // Convert lbs to kg
         }
        ...
        viewModel.logNewWorkout(
            ...
            weight: weightInKg,
            distance: isDistance ? (distanceMiles > 0 ? distanceMiles : nil) : nil,
